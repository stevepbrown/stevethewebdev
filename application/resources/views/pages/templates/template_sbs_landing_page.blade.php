      	        ...
      	        <section class="showcase">
      	          <div class="container-fluid p-0">
      	            ...
      	            <div class="row no-gutters">
      	              ...
      	              <div id="div-img-showcase-A" class="col-lg-6 order-lg-2 text-white showcase-img" title="Background image 1 for  {{$trade['name']}}"></div>
      	            ...
      	            <div class="row no-gutters">
      	              <div id="div-img-showcase-B" class="col-lg-6 text-white showcase-img"  title="Background image 2  {{$trade['name']}}"></div>
      	            ...
      	            <div class="row no-gutters">
      	              <div id="div-img-showcase-C" class="col-lg-6 order-lg-2 text-white showcase-img"  title="background image 3 for  {{$trade['name']}}"></div>
      	              <div class="col-lg-6 order-lg-1 my-auto showcase-text">
