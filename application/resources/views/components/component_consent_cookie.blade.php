...
<form action="./ajax/consent_cookies"  class="card">
  ...
  <div id="section-cookie-policy" class="collapse text-muted">
    ...
    <p>This cookie policy details how this site uses cookies in accordance with EU law. Consent to use these cookies is
    ...
    <ul>
      ...
      <li>This site does <strong>NOT</strong> use 3rd Party cookies for the purposes of tracking you, and no Personally
